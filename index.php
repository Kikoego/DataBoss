<?php
	...
	require_once $_SERVER['DOCUMENT_ROOT'] . '/DataBase/project/config/connection.php';
	...
	spl_autoload_register(function($class) {
		...
		$path = $_SERVER['DOCUMENT_ROOT'] . '/DataBase'. DIRECTORY_SEPARATOR . $nameSpace . DIRECTORY_SEPARATOR . $className . '.php';
	...
	$routes = require $_SERVER['DOCUMENT_ROOT'] . '/DataBase/project/config/routes.php';
